...
<?php while ( have_posts() ) : the_post(); ?>
	<div class="tribe-events-organizer">
		...
		<div class="tribe-events-organizer-meta tribe-clearfix">
			...
			<?php } else { ?>
				<div class="cmk-event-author-image">
					<?php echo do_shortcode('[bpps_profile_avatar user_id="' . $author_id . '"]');?>
				</div>
				<div class="tribe-organizer-description tribe-events-content">		
					<?php echo do_shortcode('[bpps_profile_field user_id="' . $author_id . '" field="Bio"]');?>
				</div>
				<?php
			}?>
